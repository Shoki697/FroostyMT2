	...
	(
		{
			...
			(
				...
				## Pet Hatching Money
				{
					...
					"children" :
					(
						{"name":"HatchingMoney", "type":"text", "x":0, "y":0, "text": "Price: 100.000 Yang", "r":1.0, "g":1.0, "b":1.0, "a":1.0, "all_align" : "center"},
					),
				},
				...
				{ 
					...
					"children" :
					(
						{"name":"PetNamingTitle", "type":"text", "x":0, "y":0, "text":"Pet Name", "all_align" : "center"},
					),
				},
			),				
		},
