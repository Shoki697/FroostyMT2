...
if app.ENABLE_QUEST_RENEWAL:
	...
	window["children"][0]["children"] = window["children"][0]["children"] + [
	{
		...
		(
			...
			{ "name" : "Quest_Name_00", "type" : "text", "text" : "�̸��Դϴ�", "x" : 60, "y" : 14 },
			{ "name" : "Quest_LastTime_00", "type" : "text", "text" : "���� �ð� �Դϴ�", "x" : 60, "y" : 30 },
			{ "name" : "Quest_LastCount_00", "type" : "text", "text" : "���� ���� �Դϴ�", "x" : 60, "y" : 46 },

			{ "name" : "Quest_Name_01", "type" : "text", "text" : "�̸��Դϴ�", "x" : 60, "y" : 74 },
			{ "name" : "Quest_LastTime_01", "type" : "text", "text" : "���� �ð� �Դϴ�", "x" : 60, "y" : 90 },
			{ "name" : "Quest_LastCount_01", "type" : "text", "text" : "���� ���� �Դϴ�", "x" : 60, "y" : 106 },

			{ "name" : "Quest_Name_02", "type" : "text", "text" : "�̸��Դϴ�", "x" : 60, "y" : 134 },
			{ "name" : "Quest_LastTime_02", "type" : "text", "text" : "���� �ð� �Դϴ�", "x" : 60, "y" : 150 },
			{ "name" : "Quest_LastCount_02", "type" : "text", "text" : "���� ���� �Դϴ�", "x" : 60, "y" : 166 },

			{ "name" : "Quest_Name_03", "type" : "text", "text" : "�̸��Դϴ�", "x" : 60, "y" : 194 },
			{ "name" : "Quest_LastTime_03", "type" : "text", "text" : "���� �ð� �Դϴ�", "x" : 60, "y" : 210 },
			{ "name" : "Quest_LastCount_03", "type" : "text", "text" : "���� ���� �Դϴ�", "x" : 60, "y" : 226 },

			{ "name" : "Quest_Name_04", "type" : "text", "text" : "�̸��Դϴ�", "x" : 60, "y" : 254 },
			{ "name" : "Quest_LastTime_04", "type" : "text", "text" : "���� �ð� �Դϴ�", "x" : 60, "y" : 270 },
			{ "name" : "Quest_LastCount_04", "type" : "text", "text" : "���� ���� �Դϴ�", "x" : 60, "y" : 286 },
		),
	},]
