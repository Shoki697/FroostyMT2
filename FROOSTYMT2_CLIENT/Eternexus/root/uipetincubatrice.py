...
class PetSystemIncubator(ui.ScriptWindow):
	...
	def LoadPetIncubatorImg(self, new_pet):
		petarryname = ["Monkey Egg", "Spider Egg", "Razador Egg", "Nemere Egg", "Blue Dragon Egg", "Red Dragon Egg", "Grim Reaper Egg", "Executioner's Egg", "Baashido Egg"]
		petarryimg = [55701, 55702, 55703, 55704, 55705, 55706, 55707, 55708, 55709]
