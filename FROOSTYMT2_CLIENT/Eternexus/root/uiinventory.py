...
class InventoryWindow(ui.ScriptWindow):
	...
	if app.ENABLE_COSTUME_ATTR_SYSTEM:
		USE_TYPE_TUPLE = ("USE_CLEAN_SOCKET", "USE_CHANGE_ATTRIBUTE", "USE_ADD_ATTRIBUTE", "USE_ADD_ATTRIBUTE2", "USE_ADD_ACCESSORY_SOCKET", "USE_PUT_INTO_ACCESSORY_SOCKET", "USE_PUT_INTO_BELT_SOCKET", "USE_PUT_INTO_RING_SOCKET", "USE_COSTUME_ENCHANT", "USE_RESET_COSTUME_ATTR")
	else:
	...
	def __IsUsableItemToItem(self, srcItemVNum, srcSlotPos):
		...
		if srcItemVNum >= 55701 and srcItemVNum <= 55709:
			return True
	...
	def __CanUseSrcItemToDstItem(self, srcItemVNum, srcSlotPos, dstSlotPos):
		...
		if srcItemVNum >= 55701 and  srcItemVNum <= 55709 and player.GetItemIndex(dstSlotPos) == 55002:			
			return True		
		
		if srcItemVNum == 55001 and player.GetItemIndex(dstSlotPos) >= 55701 and player.GetItemIndex(dstSlotPos) <= 55709:			
			return True
		if item.IsRefineScroll(srcItemVNum):
			...
			elif useType == "USE_COSTUME_ENCHANT" or useType == "USE_RESET_COSTUME_ATTR":
