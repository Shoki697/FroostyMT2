...
bool CInstanceBase::Create(const SCreateData& c_rkCreateData)
{
	...
	if (c_rkCreateData.m_dwRace == 34041 || c_rkCreateData.m_dwRace == 34045 || c_rkCreateData.m_dwRace == 34049 || c_rkCreateData.m_dwRace == 34053 || c_rkCreateData.m_dwRace == 34064 || c_rkCreateData.m_dwRace == 34073 || c_rkCreateData.m_dwRace == 34075 || c_rkCreateData.m_dwRace == 34080)
	{
...
if (GetInstanceType() == CActorInstance::TYPE_ENEMY)
	...
	if (GetInstanceType() == CActorInstance::TYPE_STONE)
		m_dwLevel = CPythonNonPlayer::Instance().GetMetinStoneLevel(GetRace());
	else
...
#ifdef NEW_PET_SYSTEM
	if(m_dwRace == 34041 ||m_dwRace == 34045 || m_dwRace == 34049 ||m_dwRace == 34053 ||m_dwRace == 34036 ||m_dwRace == 34064 ||m_dwRace == 34073 ||m_dwRace == 34075 ||m_dwRace == 34080){
