...
void CPythonSash::AddMaterial(long long dwRefPrice, BYTE bPos, TItemPos tPos)
{
...
void CPythonSash::RemoveMaterial(long long dwRefPrice, BYTE bPos)
{
	if (bPos >= SASH_WINDOW_MAX_MATERIALS)
		return;
...
{
	return Py_BuildValue("L", CPythonSash::Instance().GetPrice());
}
